...
export default {
    request: {
        '/v1/completions': function(azureApiKey, azureResource, azureDeployment, body) {
        ...
        '/v1/chat/completions': function(azureApiKey, azureResource, azureDeployment, body) {
            const apiVersion = '2023-05-15';
        ...
        '/v1/embeddings': function(azureApiKey, azureResource, azureDeployment, body) {
            const apiVersion = '2023-05-15';
